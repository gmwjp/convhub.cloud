...
<div class="item-title mt-2">第１条【サービス】</div>
１．	当サイトの利用に際してはウェブにアクセスする必要がありますが、利用者は自らの費用と責任に必要な機器・ソフトウェア・通信手段等を用意し適切に接続・操作することとします。<br>
２．	当サイトではConvHUBに関する情報の提供ならびに販売を行っておりますが、将来、様々なサービスを追加したり、または変更・削除することがあります。<br>
...
<div class="item-title mt-2">第２条【個人情報の取り扱い】</div>
当サイトとの利用に際して利用者から取得した氏名、メールアドレス、住所、電話番号等の個人情報は、別途定める「プライバシーポリシー」に則り取り扱われます。<br>

<div class="item-title mt-2">第３条【著作権等知的財産権】</div>
１．当サイト内のプログラム、商品写真その他の知的財産権は弊社に帰属します。利用者は、当該情報を私用目的で利用される場合にかぎり使用できます。弊社に無断で、それを越えて、使用（複製、送信、譲渡、二次利用等を含む）することは禁じます。<br>
２．ConvHUBの商標は、弊社の帰属しますので、無断で使用することはできません。<br>

<div class="item-title mt-2">第４条【禁止事項】</div>
...
<div class="item-title mt-2">第５条【免責事項】</div>
...
<div class="item-title mt-2">第６条【契約解除】</div>
１．弊社は、利用者が本規約に反する行為をした場合、即時にサービスを停止することができます。<br>
２．前項の事由が発生したとき、弊社は利用者に損害賠償をすることができます。<br>

<div class="item-title mt-2">第７条【損害賠償】</div>
本規約に違反した場合、弊社に発生した損害を賠償していただきます。<br>

<div class="item-title mt-2">第８条【管轄裁判所】</div>
万が一裁判所での争いとなったときは、名古屋地方裁判所を第一審の専属管轄裁判所とします。<br>

<div class="item-title mt-2">第９条【特例】</div>
１．本規約に基づき、特別の規定が別途定められている場合があります。<br>
２．弊社の各サービスの説明のページに当規約と相反する規定があった場合は、各サービスの説明ページに記載してある規定を適用します。<br>
<br>
（附則）<br>
本規約は、2021年08月01日より施行致します。<br>
