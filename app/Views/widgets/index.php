            ...
            <tr>
                <td>
                    <div>
                        ...
                        <sapn class="ml-2"><button type="button" data-toggle="tooltip" data-placement="top" title="ウィジェットURLをコピー" class="btn btn-light btn-sm copy_button" data-widget-url="https://<?=$_SERVER["HTTP_HOST"]?>/widgets/show/<?=esc($widget->code)?>"><span class="fal fa-copy"></span></button></span>
                        ...
                        <?}?>
                        <input type="hidden" id="widget_url_<?=esc($widget->id)?>" class="form-control" readonly="true" value="https://<?=$_SERVER["HTTP_HOST"]?>/widgets/show/<?=esc($widget->code)?>">
                    </div>
                </td>
